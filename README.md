...
本项目采用 `MIT` 许可证，见 [LICENSE](F:/QtProject/DicomViewer/LICENSE)。

这意味着：

- 你可以使用、复制、修改、发布和分发本项目代码
- 保留原始版权声明和许可证文本即可

需要注意：

- `MIT` 只覆盖本仓库自身代码
- 工程依赖的 Qt、VTK、ITK、GDCM 及其他第三方库，仍需分别遵守它们各自的许可证要求
- 如果你基于本项目做对外发布，建议补充第三方依赖许可说明和版本发布记录
